...
enum EnglishSoundCatalog {
    ...
    static let vowels: [EnglishSound] = [
        sound("short_a", "Short /a/", .vowel, .ae, traceCharacter: "A",
              level1: ("Apple", [0, 1]),
              level2: [("After", [0, 1]), ("Cat", [1, 1]), ("Hat", [1, 1]), ("Pan", [1, 1]), ("Bag", [1, 1])],
        ...
        sound("short_i", "Short /i/", .vowel, .ih, traceCharacter: "I",
              level1: ("Interest", [0, 1]),
              level2: [("Busy", [3, 1]), ("English", [4, 1]), ("Bit", [1, 1]), ("Sit", [1, 1]), ("Fish", [1, 1])],
              level3: [("Kitten", [2, 1]), ("Little", [2, 1]), ("Winter", [2, 1]), ("Picture", [2, 1])]),
        sound("short_o", "Short /o/", .vowel, .ah, traceCharacter: "O",
              level1: ("October", [0, 1]),
              level2: [("Water", [1, 1]), ("Hot", [1, 1]), ("Cot", [1, 1]), ("Pond", [1, 1]), ("Rock", [2, 1])],
              level3: [("Promise", [2, 1]), ("Honest", [0, 1]), ("Dollar", [1, 1]), ("Doctor", [1, 1])]),
        ...
        sound("long_a", "Long /a/", .vowel, .ay, traceCharacter: "A",
              level1: ("Make", [1, 1]),
              level2: [("Flavor", [2, 1]), ("Day", [1, 1]), ("Rain", [1, 2]), ("Play", [1, 2]), ("Say", [1, 1])],
              level3: [("Rainbow", [1, 2]), ("Holiday", [2, 1]), ("Today", [2, 1]), ("Away", [2, 1])]),
        sound("long_e", "Long /e/", .vowel, .i, traceCharacter: "E",
              level1: ("Feet", [1, 2]),
              level2: [("Evening", [0, 1]), ("See", [1, 2]), ("Bee", [1, 2]), ("Tree", [1, 2]), ("Me", [1, 1])],
              level3: [("Speech", [2, 2]), ("Feast", [1, 2]), ("Sweet", [1, 2]), ("Complete", [2, 2])]),
        ...
        sound("long_o", "Long /o/", .vowel, .oh, traceCharacter: "O",
              ...
              level3: [("Ocean", [0, 1]), ("Broken", [2, 1]), ("Golden", [2, 1]), ("Focus", [2, 1])]),
        ...
        sound("long_oo", "Long /oo/", .vowel, .u, traceCharacter: "OO",
              level1: ("Flew", [2, 2]),
              level2: [("Blue", [2, 2]), ("Group", [2, 2]), ("Moon", [1, 2]), ("Food", [1, 2]), ("Room", [1, 2])],
    ...
    static let consonants: [EnglishSound] = [
        ...
        sound("f", "/f/", .consonant, .f, traceCharacter: "F",
              level1: ("Fan", [0, 1]),
              level2: [("Phone", [1, 2]), ("Often", [1, 1]), ("Fun", [0, 1]), ("Fog", [0, 1]), ("Fin", [0, 1])],
        ...
        sound("j", "/j/", .consonant, .j, traceCharacter: "J",
              level1: ("Jewelry", [0, 1]),
              level2: [("Giraffe", [0, 1]), ("Edge", [1, 2]), ("Jump", [0, 1]), ("Jet", [0, 1]), ("Gem", [0, 1])],
              level3: [("Jungle", [0, 1]), ("Jacket", [0, 1]), ("Enjoy", [2, 1]), ("Gym", [0, 1])]),
        ...
        sound("n", "/n/", .consonant, .n, traceCharacter: "N",
              level1: ("Funny", [2, 2]),
              level2: [("Nose", [0, 1]), ("Know", [1, 1]), ("Nap", [0, 1]), ("Net", [0, 1]), ("Nut", [0, 1])],
        ...
        sound("s", "/s/", .consonant, .s, traceCharacter: "S",
              level1: ("Sun", [0, 1]),
              level2: [("Circle", [0, 1]), ("Pace", [2, 1]), ("Course", [4, 1]), ("Sit", [0, 1]), ("Soap", [0, 1])],
              level3: [("Sister", [0, 1]), ("Sunshine", [0, 1]), ("Castle", [3, 1]), ("Science", [0, 1]), ("Bus", [1, 1])]),
        ...
        sound("ch", "/ch/", .consonant, .ch, traceCharacter: "CH",
              level1: ("Touch", [3, 2]),
              level2: [("Chin", [0, 2]), ("Chip", [0, 2]), ("Chat", [0, 2]), ("Chop", [0, 2]), ("Lunch", [2, 2])],
        ...
        sound("th_voiced", "Voiced /th/", .consonant, .eth, traceCharacter: "TH",
              level1: ("This", [0, 2]),
              level2: [("That", [0, 2]), ("These", [0, 2]), ("Those", [0, 2]), ("Them", [0, 2]), ("Then", [0, 2])],
              level3: [("They", [0, 2]), ("Mother", [3, 2]), ("Brother", [3, 2]), ("Weather", [3, 2]), ("Together", [1, 2])]),
